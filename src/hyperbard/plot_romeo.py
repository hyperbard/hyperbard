...
from plot_romeo_hypergraphs import plot_romeo_hypergraphs
...
if __name__ == "__main__":
    ...
    #     node_size=50,
    # )
    # position_full_radial_labels(G1, labels, pos, font_size)
    # save_pgf_fig(
    ...
    #     node_size=50,
    # )
    # position_full_radial_labels(G2, labels, pos, font_size)
    # save_pgf_fig(
    ...
    # )
    # position_full_radial_labels(G3_for_drawing, labels, pos, font_size)
    # save_pgf_fig(
    ...
    # )
    # position_bipartite_labels(G1_subgraph, pos, labels, font_size)
    #
    # save_pgf_fig(
