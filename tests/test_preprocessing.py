...
<TEI xmlns="http://www.tei-c.org/ns/1.0">
  <text>
    ...
    def test_get_agg_xml_df(self):
        ...
        self.assertEqual(agg_df.at[0, "stagegroup_renumbered"], 1)
        self.assertEqual(agg_df.at[1, "stagegroup_renumbered"], 1)
    ...
    def test_get_grouped_df(self):
        ...
        self.assertEqual(grouped.at[0, "stagegroup_renumbered"], 1)
        self.assertEqual(grouped.at[1, "stagegroup_renumbered"], 1)
    ...
    def test_set_stagegroup(self):
        ...
        set_onstage(xml_df)
        set_stagegroup(xml_df)
        self.assertEqual(len(xml_df.stagegroup.unique()), 3)
        self.assertSetEqual(
            set(xml_df.query("tag == 'div' and n == '1'")["stagegroup"].unique()), {0}
        )
        self.assertSetEqual(
            set(xml_df.query("n == 'SD 1.1.0'")["stagegroup"].unique()), {1}
        )
        self.assertSetEqual(
            set(xml_df.query("n == 'SD 1.1.20.1'")["stagegroup"].unique()), {2}
        )
